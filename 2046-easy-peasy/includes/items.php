...
$view = array(
	...
	'b2046_general_visibility' => array( 
		...
		'item_title' => __('Permissions','p_2046s_loop_widget'),
		'item_note' => __('Who will be able to see the widget result.','p_2046s_loop_widget'),
		// gui
		'gui' => array(
			array(
				'ui_type' => 'select_box', // 0 input, 1 select box, 2 multiple select box, 3 check box, 4 radio button, 5 textarea. 6 hidden
				'choices' => $levels,
				'value' => $levels['level_10'],
				'esc' => 'stip_tags'
			)
		),
		// logic
	...
	'b2046_post_type' => array(
		...
		'position' => 1,
		'block' => 'general', // 0 = general, 1 = view, 2 = logic 
		'item_title' => __('Post type','p_2046s_loop_widget'),
		'item_note' =>  __('Select post type','p_2046s_loop_widget'),
		// gui
		'gui' => array(
			array(
	...
	'b2046_scafolding' => array(
		...
		'position' => 4,
		'block' => 'general', // 0 = general, 1 = view, 2 = logic 
		'item_title' => __('Scafolding','p_2046s_loop_widget'),
		'item_note' => __('Setup the HTML-CSS structure.','p_2046s_loop_widget'),
		// gui
		'gui' => array(
			array(
				'ui_type' => 'select_box', // 0 input, 1 select box, 2 multiple select box, 3 check box, 4 radio button, 5 textarea
	...
	'b2046_title' => array(
		...
		'position' => 0,
		'block' => 'general', // 0 = general, 1 = view, 2 = logic 
		'item_title' => __('Widget title','p_2046s_loop_widget'),
		'item_note' => __('Used for administrative purpose.', 'p_2046s_loop_widget'),
		// gui
		'gui' => array(
			array(
	...
	'b2046_note' => array(
		...
		'position' => 4,
		'block' => 'general', // 0 = general, 1 = view, 2 = logic 
		'item_title' => __('Widget description','p_2046s_loop_widget'),
		'item_note' => __('Widget intention. Used for administrative purpose.', 'p_2046s_loop_widget'),
		// gui
		'gui' => array(
			array(
				'ui_type' => 'textarea', // 0 input, 1 select box, 2 multiple select box, 3 check box, 4 radio button, 5 textarea
				'choices' => '',
				'value' => array('0' => __('Default scaffolding')),
				'esc' => 'stip_tags'
			)
		)
	),
	...
	'b2046_post_title' => array(
		...
		'item_title' => __('Object title','p_2046s_loop_widget'),
		'item_note' => __('', 'p_2046s_loop_widget'),
		// gui
		'gui' => array(
			array(
	...
	'b2046_post_content' => array(
		...
		'position' => 1,
		'block' => 'view', // 0 = general, 1 = view, 2 = logic 
		'item_title' => __('Object content','p_2046s_loop_widget'),
		'item_note' => __('', 'p_2046s_loop_widget'),
		// gui
		'gui' => array(
			array(
